			...
			<div class="registration__form">
				<form class="registration-form" method="POST" action="/">
					...
					<div class="registration-form__group">
						...
						<input class="registration-form__group-input" type="email" name="user-email" placeholder="Email">
					</div>
					<div class="registration-form__group">
					...
					<div class="registration-form__group">
						<div class="registration-form__group-sex">
							<div class="registration-form__group-sex-item">
								...
								<input class="registration-form__group-input" id="user-male" type="radio" name="user-sex" value="male" checked="checked">
							</div>
							<div class="registration-form__group-sex-item">
								<label class="registration-form__group-label" for="user-female">Жен</label>
								<input class="registration-form__group-input" id="user-female" type="radio" name="user-sex" value="female">
							</div>
						</div>
					</div>
					<div class="registration-form__group registration-form__group_select">
						...
						<select class="registration-form__group-input registration-form__group-select" name="user-group-type">
					...
					<div class="registration-form__group">
						<div class="registration-form__group_is-group"><a class="registration-form__group-submit registration-form__group-submit-js-1 registration-form__group-submit_tab registration-form__group-submit_active" href="#">Один</a><a class="registration-form__group-submit registration-form__group-submit-js-1 registration-form__group-submit_tab" href="#" command>Команда</a>
							<div class="registration-form__command"><a class="registration-form__group-submit registration-form__group-submit-js-2 registration-form__group-submit_tab registration-form__group-submit_active" href="#">Хочу в команду</a><a class="registration-form__group-submit registration-form__group-submit-js-2 registration-form__group-submit_tab" href="#">Создать свою команду</a>
								<div class="registration-form__command-select-wrapp">
									<div class="registration-form__group registration-form__group_select registration-form__command-select registration-form__command-select_active">
										...
										<select class="registration-form__group-input registration-form__group-select" name="user-group-command">
									...
									<div class="registration-form__group registration-form__command-select">
										...
										<input class="registration-form__group-input" type="text" name="user-new-command" placeholder="Название команды">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="registration-form__group registration-form__group_center">
						<button class="registration-form__group-submit" type="submit" disabled="disabled">Оплатить билет</button>
					</div>
				</form>
			</div>
		</div>
