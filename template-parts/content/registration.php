            ...
            <div class="registration__inner">
                ...
                <div class="registration__form">
                    <form class="registration-form" method="POST" action="<?= betta_get_webpay_url() ?>">
                        ...
                        Контактные данные используются для заполнения расписки о личной ответственности за жизнь и здоровье, а также для связи в экстренных случаях, не публикуются. В день проведения мероприятия вам необходимо будет предъявить документ, удостоверяющий личность.<br><br>
                        В случае неявки, отказа, или неучастия в соревнованиях по любой другой причине, оплата за стартовый взнос не возвращается.<br><br>
                        Оплата стартового взноса производится банковской картой через Интернет (через систему электронных платежей WEBPAY) в режиме реального времени. Безопасный сервер WEBPAY устанавливает шифрованное соединение по защищенному протоколу TLS и конфиденциально принимает от клиента данные его платёжной карты (номер карты, имя держателя, дату окончания действия, и контрольный номер банковской карточки CVC/CVC2).                        После совершения оплаты с использованием банковской карты необходимо сохранять полученные карт-чеки (подтверждения об оплате, полученные в Интернет-магазине) для сверки с выпиской по карт-счёту (с целью подтверждения совершённых операций в случае возникновения спорных ситуаций)<br><br>
                        Счет выставляется только в белорусских рублях. Оплатить его можно с карточки, эмитированной в любой валюте. К оплате принимаются карты Visa/MasterCard/Белкарт всех типов.<br><br>
                        В случае, если Вы не получили подтверждение об оплате, Вам необходимо обратиться в службу технической поддержки по телефону +375 (29) 383-71-72 или e-mail <a href="mailto:support@webpay.by">support@webpay.by</a><br><br>
                        </p>
                    </form>
                </div>
            </div>
