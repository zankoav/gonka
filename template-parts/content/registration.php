    ...
    <div class="registration">
        <div class="container">
            <div class="registration__inner">
                <h1 class="title">Для регистрации на гонку необходимо <a href="/my-account">зарегистрироваться и
                        войти</a> на сайт</h1>
            </div>
        </div>
    </div>
						...
						<?php if ( ! $validCoupon ) : ?>
                            <form clas="registration-form" method="get" ?>
                                <div class="registration-form__group">
                                    ...
                                    <input style="width:59%" class="registration-form__group-input" type="text"
                                           name="coupon"
                                           placeholder="Купон"
									...
									<?php endif; ?>
                                    <button style="width:40%; padding: 0.62rem 2rem;"
                                            class="registration-form__group-submit" type="submit">Применить
                                    </button>
						...
						<?php if ( $kids && ( ! $kidsData || $kidsErrors ) ): ?>
                            <form class="registration-form" method="POST"
								...
								<?php if ( $validCoupon ): ?>
                                    ...
                                    <div style="padding: 10px;margin: 10px 0 20px 0 ;border:1px dashed;font-size:16px;color: #aaa">
                                        Использован купон <?= $validCoupon['code'] ?> со
                                        скидкой <?= $validCoupon['discount'] ?>%
                                    </div>
								<?php endif; ?>
                                <div class="registration-form__group">
                                ...
                                <div class="registration-form__group-sex">
                                    ...
                                    <div class="registration-form__group-sex-item">
                                        ...
                                        <input class="registration-form__group-input" style="width: 20px"
                                               id="user-female"
						...
						<?php else: ?>
                            <form class="registration-form" method="POST" action="/betta/register">
                                ...
                                <a style="font-size: 20px;" target="_blank"
                                   href="<?= get_permalink( get_page_by_path( 'faq' ) ) ?>">Как правильно выбрать
                                    формат?</a>
								<?php if ( $kids && $kidsData ): ?>
                                    <div class="registration-form__group">
                                        <label class="registration-form__group-label">Имя</label>
                                        <input type="hidden" name="kid-first-name"
                                               value="<?= $_POST['kid-first-name'] ?>">
                                        <span style="color: #e8471e"><?= $_POST['kid-first-name'] ?></span>
                                    </div>
                                    <div class="registration-form__group">
                                        <label class="registration-form__group-label">Фамилия</label>
                                        <input type="hidden" name="kid-last-name"
                                               value="<?= $_POST['kid-last-name'] ?>">
                                ...
                                <div class="registration-form__group">
                                    <input style="margin: 0 10px 0 0;" type="checkbox" name="transfer"
                                           id="transfer-field"><label
                                            style="display: inline; cursor: pointer;font-size:14px;"
                                            class="registration-form__group-label" for="transfer-field">Нужен
                                        трансфер</label>
                                </div>
